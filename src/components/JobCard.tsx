...
export default function JobCard({ job, isSelected, onSelect }: JobCardProps) {
    return (
        ...
        >
            {/* This wrapper fades inactive content but doesn't touch the badge row */}
            <div className={cn(!job.isActive && "opacity-60")}>
            ...
            {/* Badge row: always full colour so red Expired stays vivid */}
